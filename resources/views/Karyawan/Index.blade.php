                        ...
                        <tbody>
                            @forelse ($karyawans as $key => $karyawan)
                                <tr>
                                    ...
                                    <td>
                                        <img class="img-fluid" width="200px" src="{{ asset($karyawan->qrcode) }}"
                                            alt="">
                                    </td>
                                    <td>
                                        <a href="" class="btn btn-sm btn-primary"><iconify-icon
                                                icon="mdi:eye"></iconify-icon></a>
                                        <a href="" class="btn btn-sm btn-warning"><iconify-icon
                                                icon="mdi:edit"></iconify-icon></a>
                                        <a href="" class="btn btn-sm btn-danger"><iconify-icon
